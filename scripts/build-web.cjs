...
const files=['index.html','android-privacy.html','style.css','campaign.css','engine.js','sound.js','characters.js','game.js','online.js','cosmic-lantern.png','vavi-tech-logo.png','jonah-run.png','logo.svg'];
